					...
					<form:form id="loginForm" action="login" method="POST"
						...
						<div class="group">
							<label for="pass" class="label">Password</label> <input
								...
								placeholder="Nhập vào mật khẩu" data-type="password" required autofocus/>
						</div>
						<div class="group">
				...
				<div class="sign-up-htm">
					<form:form modelAttribute="loginBean" action="register"
						...
						<div class="group">
							...
							<label for="name" class="label">Fullname</label> <input id="name"
						...
						<div class="group">
							<label for="gender" class="label">Giới tính</label> <input
								type="radio" id="gender" name="gender" value=0 name="gender"
								checked> Nam <input type="radio" id="gender"
								name="gender" value=1 name="gender"> Nữ <input
